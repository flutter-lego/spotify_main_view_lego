...
[![pub package](https://img.shields.io/pub/v/spotify_main_view_lego.svg)](https://pub.dartlang.org/packages/spotify_main_view_lego)
...
# spotify_main_view_lego
<img src="https://github.com/juneview-songdo/spotify_main_view/assets/21379657/c8eb5e9e-5391-4b21-8a48-50252aa578ef" width="200" alt="toss_intro_page_lego">
...
2. To add Lego to your project, enter the following command in the terminal at the root of your project:
   ```bash
   lego add spotify_main_view_lego
   ```
3. run the following command to generate the widget: 
    ```bash
    flutter run -d chrome lib/widget_book/spotify_main_view_lego/_/_.dart
    ```
